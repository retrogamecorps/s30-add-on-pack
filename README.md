...
- Unfortunately, save files do not seem to be persistent. Something with the power-down system on the device will wipe save files (similar to the core options file issue above). Some tips from the community include opening and saving another game as soon as you close the first game to make sure the save file sticks. Until the firmware itself can be fixed, this issue may be permanent.
- If you are not satisfied by the full-screen aspect ratio for every system, you can change it yourself relatively easy.  Check out my writen guide for detailed instructions: https://retrogamecorps.com/2021/01/08/pocketgo-s30-starter-guide/
